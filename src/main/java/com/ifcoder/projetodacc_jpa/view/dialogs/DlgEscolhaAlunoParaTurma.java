...
import com.ifcoder.projetodacc_jpa.controller.AlunoController;
 ...
 * @author jose
 */
public class DlgEscolhaAlunoParaTurma extends javax.swing.JDialog {
    ...
    public DlgEscolhaAlunoParaTurma(java.awt.Frame parent, boolean modal, Turma turma) {

        super(parent, modal);
        initComponents();
        
        this.alunoController = new AlunoController();
        this.itemEscolhido = new Aluno();
        this.turma = turma;

        this.alunoController.atualizarTabela(grdItens);
    }
    ...
    private void btnAddItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddItemActionPerformed
        if (itemEscolhido == null) {
            ...
            if(turma.getLstAlunos().contains(itemEscolhido))
                JOptionPane.showMessageDialog(null, "Este aluno(a) já está cadastrado(a).");
            else{
                this.turma.getLstAlunos().add(itemEscolhido);
                dispose();
            }
        }
    ...
    private void grdItensMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_grdItensMouseClicked
        itemEscolhido = (Aluno) this.getObjetoSelecionadoNaGrid();
    ...
    private void edtNomeKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_edtNomeKeyPressed
        ...
        if(!nomeDigitado.isEmpty())
            this.alunoController.atualizarTabela(grdItens, nomeDigitado);
        else
            this.alunoController.atualizarTabela(grdItens);
